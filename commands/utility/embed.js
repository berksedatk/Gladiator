...
module.exports = {
  name: "embed",
  category: "Utility",
  description: "Creates a embed for you",
  aliases: ["em"],
  cooldown: 10,
  ...
  async execute(bot, message, args) {
    ...
    if (!collected.first()) return message.channel.send("<:cross:724049024943915209> | Command timed out.");
    if (collected.first().content.toLowerCase() === "cancel") return message.channel.send("<:cross:724049024943915209> | Command cancelled.");
    if (collected.first().content.toLowerCase() === "skip") {
      ...
      if (collected.first().content.length > 256) return message.channel.send("<:cross:724049024943915209> | Author name cannot exceed 256 characters. Command cancelled.");
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        return message.channel.send("<:cross:724049024943915209> | No image attached, command cancelled.");
      }
      ...
      if (collected.first().content.toLowerCase() === "skip") {
        ...
        if (!validURL(collected.first().content)) return message.channel.send("<:cross:724049024943915209> | That's not a valid URL. Command cancelled.");
    ...
    if (collected.first().content.toLowerCase() === "skip") {
      ...
      if (collected.first().content.length > 256) return message.channel.send("<:cross:724049024943915209> | Title cannot exceed 256 characters. Command cancelled.");
    ...
    if (collected.first().content.toLowerCase() === "skip") {
      ...
      if (collected.first().content.length > 2048) return message.channel.send("<:cross:724049024943915209> | Description cannot exceed 2048 characters. Command cancelled.");
    ...
    if (collected.first().content.toLowerCase() === "skip") {
      ...
      if (!validHex(collected.first().content)) return message.channel.send("<:cross:724049024943915209> | Invalid Hex code. Command cancelled.");
    ...
    if (collected.first().content.toLowerCase() === "skip") {
      ...
      if (!collected.first().attachments.first()) return message.channel.send("<:cross:724049024943915209> | No image attached. Command cancelled.");
    ...
    if (collected.first().content.toLowerCase() != "yes") {
      ...
      while(count < 25) {
        ...
        if (collected.first().content.toLowerCase() === "skip") {
          ...
          if (collected.first().content.length > 256) return message.channel.send("<:cross:724049024943915209> | Field name cannot exceed 256 characters. Command cancelled.");
          ...
          if (!collected.first()) return message.channel.send("<:cross:724049024943915209> | Command timed out.");
          if (collected.first().content.toLowerCase() === "cancel") return message.channel.send("<:cross:724049024943915209> | Command cancelled.");
          if (collected.first().content.length > 2048) return message.channel.send("<:cross:724049024943915209> | Field value cannot exceed 2048 characters. Command cancelled.");
    ...
    if (collected.first().content.toLowerCase() === "skip") {
      ...
      if (collected.first().content.length > 2048) return message.channel.send("<:cross:724049024943915209> | Footer text cannot exceed 2048 characters. Command cancelled.");
    ...
    if (!channel) return message.channel.send("<:cross:724049024943915209> | You didn't mention a true channel. Command cancelled.");
    channel.send(embed).then(() => {
      msg.delete()
      embedMsg.delete()
      return message.channel.send(`<:tick:724048990626381925> | Embed has been successfully sent in ${channel}.`, embed)
    }).catch(err => {
